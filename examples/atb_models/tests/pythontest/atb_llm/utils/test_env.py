...
class TestOmniAttentionPatternFile(unittest.TestCase):
    ...
    def test_omni_attention_pattern_file_standardize_exception_case_propagation(self, mock_standardize, mock_check_safety):
    ...
    @patch('atb_llm.utils.file_utils.check_file_safety')
    @patch('atb_llm.utils.file_utils.standardize_path')
    def test_omni_attention_pattern_file_check_safety_exception_case_propagation(self, mock_standardize, mock_check_safety):
