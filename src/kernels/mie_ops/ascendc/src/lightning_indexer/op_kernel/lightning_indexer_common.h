...
/*!
 * \file llightning_indexer_common.h
 * \brief
 */
#ifndef LLIGHTNING_INDEXER_COMMON_H
#define LLIGHTNING_INDEXER_COMMON_H
...
struct ConstInfo {
    ...
    uint64_t kHeadNum;
    uint64_t headDim;
    uint64_t selectedCount;  // topK选取大小
...
#endif // LLIGHTNING_INDEXER_COMMON_H